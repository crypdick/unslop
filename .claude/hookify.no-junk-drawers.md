...
Name shared code after its purpose. If you need a shared utility, name it after what it does and put it where it belongs. Prefer a well-named shared package with centralized invariants over custom helpers scattered across domains. If only one module uses the functions, keep them in that module.
